...
* [c4](https://github.com/kenrick95/c4) - Connect Four game, with AI, in HTML/CSS/JS. [Play it now!](https://kenrick95.github.io/c4/)
...
* [Backdooms](https://github.com/Kuberwastaken/backdooms) - Game inspired by DOOM 1993 and The Backrooms, small enough to be self contained inside a QR code. [Play it now!](https://kuber.studio/backdooms/)
...
* [Bitburner](https://github.com/bitburner-official/bitburner-src) - Bitburner is a programming-based incremental game that revolves around hacking and cyberpunk themes. Written with Typescript. [Play it now!](https://bitburner-official.github.io/)
...
* [Farbrausch demo tools](https://github.com/OpenSourceVideoGames/fr_public) - .kkrieger beta game in 96kb [Play it now!](https://web.archive.org/web/20100304155706/http://www.theprodukkt.com/kkrieger#20)
...
* [Mindustry](https://github.com/Anuken/Mindustry) - Automation meets Tower Defense in this space themed RTS
 ...
 * [Saint Aveline](https://github.com/DogFingerStudios/saintaveline) - First-person survival horror game set on a remote island where isolation, scarcity, and mistrust are constant threats. Written in Unity.
...
* [Pimple Popper](https://github.com/Crazy-Marvin/PimplePopper) - Game to pop pimples using the awesome Godot Engine. https://crazymarvin.com/pimple-popper/
...
* [HaxeFlixel](https://github.com/HaxeFlixel/flixel) - Free, cross-platform 2D game engine powered by Haxe and OpenFL https://haxeflixel.com/
...
* [LÖVE](https://github.com/love2d/love) - LÖVE is an awesome 2D game framework for Lua. https://love2d.org/
